...
**Profile** — The personal introduction for Edoardo Galli: name, handle, role, short bio, location, and primary calls to action.
...
**Portfolio Section** — A top-level page region: navigation, hero, projects, contact, or footer.
